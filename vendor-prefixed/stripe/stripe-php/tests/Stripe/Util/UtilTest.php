 ...
 * @internal
 *
 * @covers \GiftFlow\Vendor\Stripe\Util\Util
 */
final class UtilTest extends \GiftFlow\Vendor\Stripe\TestCase
{
    ...
    {
        $customer = Util::convertToStripeObject(['id' => 'cus_123', 'object' => 'customer'], null);
    ...
    {
        $params = ['foo' => 'bar', 'customer' => Util::convertToStripeObject(['id' => 'cus_123', 'object' => 'customer'], null), 'null_value' => null];
        self::assertSame(['foo' => 'bar', 'customer' => 'cus_123'], Util::objectsToIds($params));
    }
    public function testEncodeParameters()
    {
        ...
        self::assertSame('a=3&b=%2Bfoo%3F&c=bar%26baz&d[a]=a&d[b]=b&e[0]=0&e[1]=1&f=', Util::encodeParameters($params));
    }
    public function testEncodeParametersForV2Api()
    {
        ...
        self::assertSame('a=3&b=%2Bfoo%3F&c=bar%26baz&d[a]=a&d[b]=b&e[0]=0&e[1]=1&f=', Util::encodeParameters($params, 'v2'));
    }
    ...
    {
        $params = ['a' => 3, 'b' => '+foo?', 'c' => 'bar&baz', 'd' => ['a' => 'a', 'b' => 'b'], 'e' => [0, 1], 'f' => [['foo' => '1', 'ghi' => '2'], ['foo' => '3', 'bar' => '4']]];
        self::assertSame([['a', 3], ['b', '+foo?'], ['c', 'bar&baz'], ['d[a]', 'a'], ['d[b]', 'b'], ['e[0]', 0], ['e[1]', 1], ['f[0][foo]', '1'], ['f[0][ghi]', '2'], ['f[1][foo]', '3'], ['f[1][bar]', '4']], Util::flattenParams($params));
    }
}