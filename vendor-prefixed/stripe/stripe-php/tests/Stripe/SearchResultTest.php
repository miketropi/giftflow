 ...
 * @internal
 *
 * @covers \GiftFlow\Vendor\Stripe\SearchResult
 */
final class SearchResultTest extends TestCase
{
    ...
    {
        $this->fixture = SearchResult::constructFrom(['data' => [['id' => '1']], 'has_more' => true, 'url' => '/things', 'next_page' => 'WzEuMl0=']);
    }
    ...
    {
        $this->stubRequest('GET', '/things', [], null, false, ['object' => 'search_result', 'data' => [['id' => '1']], 'has_more' => true, 'url' => '/things']);
        $resources = $this->fixture->all();
        $this->compatAssertIsArray($resources->data);
    }
    public function testCanCount()
    {
        $SearchResult = SearchResult::constructFrom(['data' => [['id' => '1']]]);
        self::assertCount(1, $SearchResult);
        $SearchResult = SearchResult::constructFrom(['data' => [['id' => '1'], ['id' => '2'], ['id' => '3']]]);
        self::assertCount(3, $SearchResult);
    }
    public function testCanIterate()
    {
        $SearchResult = SearchResult::constructFrom(['data' => [['id' => '1'], ['id' => '2'], ['id' => '3']], 'has_more' => true, 'url' => '/things', 'next_page' => 'WzEuMl0=']);
        $seen = [];
    ...
    {
        $this->stubRequest('GET', '/things', ['page' => 'WzEuMl0='], null, false, ['object' => 'search_result', 'data' => [['id' => '2'], ['id' => '3']], 'has_more' => false]);
        $seen = [];
    ...
    {
        $this->stubRequest('GET', '/things', ['query' => 'metadata["foo"]:"bar"', 'limit' => 3, 'page' => 'WzEuMl0='], null, false, ['object' => 'search_result', 'data' => [['id' => '2'], ['id' => '3']], 'has_more' => false]);
        $this->fixture->setFilters(['query' => 'metadata["foo"]:"bar"', 'limit' => 3]);
        $seen = [];
        foreach ($this->fixture->autoPagingIterator() as $item) {
            $seen[] = $item['id'];
        }
    ...
    {
        $SearchResult = SearchResult::constructFrom(['data' => [['content' => 'first'], ['content' => 'middle'], ['content' => 'last']]]);
