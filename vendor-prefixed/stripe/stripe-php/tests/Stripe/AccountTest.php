 ...
 * @internal
 *
 * @covers \GiftFlow\Vendor\Stripe\Account
 */
final class AccountTest extends TestCase
{
    ...
    public function testIsSaveable()
    {
        ...
        $this->expectsRequest('post', '/v1/accounts/' . $resource->id);
        $resource->save();
        self::assertInstanceOf(Account::class, $resource);
    }
    public function testIsUpdatable()
    {
        ...
        $resource = Account::update(self::TEST_RESOURCE_ID, ['metadata' => ['key' => 'value']]);
        self::assertInstanceOf(Account::class, $resource);
    }
    public function testIsDeletable()
    {
        $resource = Account::retrieve(self::TEST_RESOURCE_ID);
        $this->expectsRequest('delete', '/v1/accounts/' . $resource->id);
        $resource->delete();
        self::assertInstanceOf(Account::class, $resource);
    }
    public function testIsRejectable()
    {
        ...
        $this->expectsRequest('post', '/v1/accounts/' . $account->id . '/reject');
    ...
    {
        $resource = Account::retrieve(self::TEST_RESOURCE_ID);
        $this->stubRequest('post', '/oauth/deauthorize', ['client_id' => Stripe::getClientId(), 'stripe_user_id' => $resource->id], null, false, ['stripe_user_id' => $resource->id], 200, Stripe::$connectBase);
        $resource->deauthorize();
    }
    public function testPersons()
    {
        $account = Account::retrieve(self::TEST_RESOURCE_ID);
        $this->expectsRequest('get', '/v1/accounts/' . $account->id . '/persons');
    ...
    public function testCanUpdateCapability()
    {
        ...
        $resource = Account::updateCapability(self::TEST_RESOURCE_ID, self::TEST_CAPABILITY_ID, ['requested' => true]);
        self::assertInstanceOf(Capability::class, $resource);
    }
    ...
    public function testCanCreatePerson()
    {
        ...
        $resource = Account::createPerson(self::TEST_RESOURCE_ID, ['dob' => ['day' => 1, 'month' => 1, 'year' => 1980]]);
    ...
    public function testCanUpdatePerson()
    {
        ...
        $resource = Account::updatePerson(self::TEST_RESOURCE_ID, self::TEST_PERSON_ID, ['first_name' => 'First name']);
        self::assertInstanceOf(Person::class, $resource);
    }
    ...
    {
        /** @var Account $obj */
        $obj = \GiftFlow\Vendor\Stripe\Util\Util::convertToStripeObject(['object' => 'account', 'legal_entity' => StripeObject::constructFrom([])], null);
        $obj['legal_entity']->additional_owners = [['first_name' => 'Joe'], ['first_name' => 'Jane']];
        $expected = ['legal_entity' => ['additional_owners' => [0 => ['first_name' => 'Joe'], 1 => ['first_name' => 'Jane']]]];
        self::assertSame($expected, $obj->serializeParameters());
    }
    public function testSerializeAddAdditionalOwners()
    {
        $obj = \GiftFlow\Vendor\Stripe\Util\Util::convertToStripeObject(['object' => 'account', 'legal_entity' => ['additional_owners' => [StripeObject::constructFrom(['first_name' => 'Joe']), StripeObject::constructFrom(['first_name' => 'Jane'])]]], null);
        $obj['legal_entity']->additional_owners[2] = ['first_name' => 'Andrew'];
        $expected = ['legal_entity' => ['additional_owners' => [2 => ['first_name' => 'Andrew']]]];
        self::assertSame($expected, $obj->serializeParameters());
    }
    public function testSerializePartiallyChangedAdditionalOwners()
    {
        $obj = \GiftFlow\Vendor\Stripe\Util\Util::convertToStripeObject(['object' => 'account', 'legal_entity' => ['additional_owners' => [StripeObject::constructFrom(['first_name' => 'Joe']), StripeObject::constructFrom(['first_name' => 'Jane'])]]], null);
        $obj['legal_entity']->additional_owners[1]->first_name = 'GiftFlow\Vendor\Stripe';
        $expected = ['legal_entity' => ['additional_owners' => [1 => ['first_name' => 'GiftFlow\Vendor\Stripe']]]];
        self::assertSame($expected, $obj->serializeParameters());
    }
    public function testSerializeUnchangedAdditionalOwners()
    {
        $obj = \GiftFlow\Vendor\Stripe\Util\Util::convertToStripeObject(['object' => 'account', 'legal_entity' => ['additional_owners' => [StripeObject::constructFrom(['first_name' => 'Joe']), StripeObject::constructFrom(['first_name' => 'Jane'])]]], null);
        $expected = ['legal_entity' => ['additional_owners' => []]];
        self::assertSame($expected, $obj->serializeParameters());
    }
    ...
    {
        $obj = \GiftFlow\Vendor\Stripe\Util\Util::convertToStripeObject(['object' => 'account'], null);
        $obj['external_account'] = 'btok_123';
        $expected = ['external_account' => 'btok_123'];
        self::assertSame($expected, $obj->serializeParameters());
    }
    public function testSerializeExternalAccountHash()
    {
        $obj = \GiftFlow\Vendor\Stripe\Util\Util::convertToStripeObject(['object' => 'account'], null);
        $obj['external_account'] = ['object' => 'bank_account', 'routing_number' => '110000000', 'account_number' => '000123456789', 'country' => 'US', 'currency' => 'usd'];
        $expected = ['external_account' => ['object' => 'bank_account', 'routing_number' => '110000000', 'account_number' => '000123456789', 'country' => 'US', 'currency' => 'usd']];
        self::assertSame($expected, $obj->serializeParameters());
    }
    public function testSerializeBankAccountString()
    {
        ...
        $expected = ['bank_account' => 'btok_123'];
        self::assertSame($expected, $obj->serializeParameters());
    }
    public function testSerializeBankAccountHash()
    {
        $obj = \GiftFlow\Vendor\Stripe\Util\Util::convertToStripeObject(['object' => 'account'], null);
        $obj['bank_account'] = ['object' => 'bank_account', 'routing_number' => '110000000', 'account_number' => '000123456789', 'country' => 'US', 'currency' => 'usd'];
        $expected = ['bank_account' => ['object' => 'bank_account', 'routing_number' => '110000000', 'account_number' => '000123456789', 'country' => 'US', 'currency' => 'usd']];
        self::assertSame($expected, $obj->serializeParameters());
    }
    ...
    {
        /** @var Account $obj */
        $obj = \GiftFlow\Vendor\Stripe\Util\Util::convertToStripeObject(['object' => 'account', 'individual' => \GiftFlow\Vendor\Stripe\Util\Util::convertToStripeObject(['object' => 'person', 'first_name' => 'Jenny'], null)], null);
        $obj->individual = ['first_name' => 'Jane'];
        $expected = ['individual' => ['first_name' => 'Jane']];
        self::assertSame($expected, $obj->serializeParameters());
    }
