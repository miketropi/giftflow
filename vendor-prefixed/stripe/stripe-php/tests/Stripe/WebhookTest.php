 ...
 * @internal
 *
 * @covers \GiftFlow\Vendor\Stripe\Webhook
 * @covers \GiftFlow\Vendor\Stripe\WebhookSignature
 */
final class WebhookTest extends TestCase
{
  ...
  "data": { "object": { "id": "rdr_123", "object": "terminal.reader" } }
    ...
    public function testValidJsonAndHeader()
    {
        ...
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\Terminal\Reader::class, $event->data->__get('object'));
    }
    ...
    {
        $this->expectException(\GiftFlow\Vendor\Stripe\Exception\SignatureVerificationException::class);
