 ...
 * @internal
 *
 * @covers \GiftFlow\Vendor\Stripe\File
 */
final class FileTest extends TestCase
{
    ...
    {
        $obj = \GiftFlow\Vendor\Stripe\Util\Util::convertToStripeObject(['object' => 'file'], null);
        self::assertInstanceOf(File::class, $obj);
    }
    public function testDeserializesFromFileUpload()
    {
        $obj = \GiftFlow\Vendor\Stripe\Util\Util::convertToStripeObject(['object' => 'file_upload'], null);
        self::assertInstanceOf(File::class, $obj);
    }
}