...
use GiftFlow\Vendor\Stripe\Events\V1BillingMeterNoMeterFoundEventNotification;
use GiftFlow\Vendor\Stripe\V2\Core\EventNotification;
/**
 * @internal
 *
 * @covers \GiftFlow\Vendor\Stripe\Event
 * @covers \GiftFlow\Vendor\Stripe\V2\Core\Event
 */
final class EventTest extends TestCase
{
    ...
    {
        $jsonEvent = ['id' => 'evt_123', 'object' => 'v2.core.event', 'type' => 'v1.billing.meter.error_report_triggered', 'created' => '2022-02-15T00:27:45.330Z', 'related_object' => ['id' => 'mtr_123', 'type' => 'billing.meter', 'url' => '/v1/billing/meters/mtr_123'], 'data' => ['reason' => ['error_count' => 1]]];
        $this->stubRequest('GET', '/v2/core/events/evt_123', [], null, false, $jsonEvent, 200, BaseStripeClient::DEFAULT_API_BASE);
        $client = new StripeClient(['api_key' => 'sk_test_client']);
        $event = $client->v2->core->events->retrieve('evt_123');
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\Events\V1BillingMeterErrorReportTriggeredEvent::class, $event);
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\EventData\V1BillingMeterErrorReportTriggeredEventData::class, $event->data);
    }
    public function testV2EventFetchRelatedObject()
    {
        $jsonEvent = ['id' => 'evt_123', 'object' => 'v2.core.event', 'type' => 'v1.billing.meter.error_report_triggered', 'created' => '2022-02-15T00:27:45.330Z', 'context' => 'acct_123', 'related_object' => ['id' => 'mtr_123', 'type' => 'billing.meter', 'url' => '/v1/billing/meters/mtr_123'], 'data' => []];
        // right now PHP only supports one request per unit test
        $fullEvent = \GiftFlow\Vendor\Stripe\Util\Util::convertToStripeObject($jsonEvent, [], 'v2');
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\Events\V1BillingMeterErrorReportTriggeredEvent::class, $fullEvent);
        $this->stubRequest('GET', '/v1/billing/meters/mtr_123', [], null, false, ['object' => 'billing.meter', 'id' => 'mtr_123'], 200, MOCK_URL);
        /** @var V1BillingMeterErrorReportTriggeredEventNotification $fullEvent */
        $meter = $fullEvent->fetchRelatedObject();
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\Billing\Meter::class, $meter);
        self::assertSame('mtr_123', $meter->id);
    }
    public function testV2EventNotificationFetchRelatedObject()
    {
        $jsonEvent = json_encode(['id' => 'evt_123', 'object' => 'v2.core.event', 'type' => 'v1.billing.meter.error_report_triggered', 'created' => '2022-02-15T00:27:45.330Z', 'context' => 'acct_123', 'related_object' => ['id' => 'mtr_123', 'type' => 'billing.meter', 'url' => '/v1/billing/meters/mtr_123']]);
        $this->stubRequest('GET', '/v1/billing/meters/mtr_123', [], null, false, ['object' => 'billing.meter', 'id' => 'mtr_123'], 200, BaseStripeClient::DEFAULT_API_BASE);
    ...
    public function testV2EventNotificationFetchEvent()
    {
        ...
        $this->stubRequest('GET', '/v2/core/events/evt_123', [], ['Stripe-Context: acct_123'], false, ['object' => 'v2.core.event', 'type' => 'v1.billing.meter.error_report_triggered', 'id' => 'mtr_123', 'data' => ['developer_message_summary' => $message]], 200, BaseStripeClient::DEFAULT_API_BASE);
        $client = new StripeClient('sk_test_123');
    ...
    {
        $eventData = json_encode(['id' => 'evt_234', 'object' => 'event', 'type' => 'v1.billing.meter.error_report_triggered', 'created' => '2022-02-15T00:27:45.330Z', 'related_object' => ['id' => 'fa_123', 'type' => 'financial_account', 'url' => '/v2/financial_accounts/fa_123'], 'reason' => ['type' => 'request', 'request' => ['id' => 'id_123', 'idempotency_key' => 'key_123']]]);
    ...
    {
        $eventData = json_encode(['id' => 'evt_234', 'object' => 'event', 'type' => 'v1.billing.meter.no_meter_found', 'created' => '2022-02-15T00:27:45.330Z']);
        $event = EventNotification::fromJson($eventData, new StripeClient());
    ...
    {
        $eventData = json_encode(['id' => 'evt_234', 'object' => 'event', 'type' => 'imaginary', 'created' => '2022-02-15T00:27:45.330Z']);
        $event = EventNotification::fromJson($eventData, new StripeClient());
