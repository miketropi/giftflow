 ...
 * @internal
 *
 * @covers \GiftFlow\Vendor\Stripe\Capability
 */
final class CapabilityTest extends TestCase
{
    ...
    public function testHasCorrectUrl()
    {
        ...
        self::assertSame('/v1/accounts/' . self::TEST_ACCOUNT_ID . '/capabilities/' . self::TEST_RESOURCE_ID, $resource->instanceUrl());
    }
    ...
    public function testIsSaveable()
    {
        ...
        $this->expectsRequest('post', '/v1/accounts/' . self::TEST_ACCOUNT_ID . '/capabilities/' . self::TEST_RESOURCE_ID);
        $resource->save();
