 ...
 * @coversNothing
 */
final class VerificationSessionTest extends \GiftFlow\Vendor\Stripe\TestCase
{
    ...
    public function testIsCreatable()
    {
        ...
        $resource = VerificationSession::create(['type' => 'id_number']);
        self::assertInstanceOf(VerificationSession::class, $resource);
    }
    public function testIsRetrievable()
    {
        $this->expectsRequest('get', '/v1/identity/verification_sessions/' . self::TEST_RESOURCE_ID);
    ...
    public function testIsUpdatable()
    {
        ...
        $resource = VerificationSession::update(self::TEST_RESOURCE_ID, ['metadata' => ['key' => 'value']]);
        self::assertInstanceOf(VerificationSession::class, $resource);
    }
