 ...
 * @internal
 *
 * @covers \GiftFlow\Vendor\Stripe\Service\InvoiceService
 */
final class InvoiceServiceTest extends \GiftFlow\Vendor\Stripe\TestCase
{
    ...
    public function testAll()
    {
        ...
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\Invoice::class, $resources->data[0]);
    }
    public function testAllLines()
    {
        $this->expectsRequest('get', '/v1/invoices/' . self::TEST_RESOURCE_ID . '/lines');
    ...
    public function testCreate()
    {
        ...
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\Invoice::class, $resource);
    }
    public function testDelete()
    {
        $this->expectsRequest('delete', '/v1/invoices/' . self::TEST_RESOURCE_ID);
        $resource = $this->service->delete(self::TEST_RESOURCE_ID);
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\Invoice::class, $resource);
    }
    public function testFinalizeInvoice()
    {
        $this->expectsRequest('post', '/v1/invoices/' . self::TEST_RESOURCE_ID . '/finalize');
        $resource = $this->service->finalizeInvoice(self::TEST_RESOURCE_ID);
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\Invoice::class, $resource);
    }
    public function testMarkUncollectible()
    {
        $this->expectsRequest('post', '/v1/invoices/' . self::TEST_RESOURCE_ID . '/mark_uncollectible');
        $resource = $this->service->markUncollectible(self::TEST_RESOURCE_ID);
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\Invoice::class, $resource);
    }
    public function testPay()
    {
        $this->expectsRequest('post', '/v1/invoices/' . self::TEST_RESOURCE_ID . '/pay');
        $resource = $this->service->pay(self::TEST_RESOURCE_ID);
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\Invoice::class, $resource);
    }
    public function testRetrieve()
    {
        $this->expectsRequest('get', '/v1/invoices/' . self::TEST_RESOURCE_ID);
        $resource = $this->service->retrieve(self::TEST_RESOURCE_ID);
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\Invoice::class, $resource);
    }
    public function testSendInvoice()
    {
        $this->expectsRequest('post', '/v1/invoices/' . self::TEST_RESOURCE_ID . '/send');
        $resource = $this->service->sendInvoice(self::TEST_RESOURCE_ID);
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\Invoice::class, $resource);
    }
    public function testUpdate()
    {
        $this->expectsRequest('post', '/v1/invoices/' . self::TEST_RESOURCE_ID);
        $resource = $this->service->update(self::TEST_RESOURCE_ID, ['metadata' => ['key' => 'value']]);
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\Invoice::class, $resource);
    }
    public function testVoidInvoice()
    {
        $this->expectsRequest('post', '/v1/invoices/' . self::TEST_RESOURCE_ID . '/void');
