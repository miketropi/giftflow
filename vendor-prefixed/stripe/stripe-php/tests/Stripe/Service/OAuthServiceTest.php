 ...
 * @internal
 *
 * @covers \GiftFlow\Vendor\Stripe\Service\OAuthService
 */
final class OAuthServiceTest extends \GiftFlow\Vendor\Stripe\TestCase
{
    ...
    {
        $this->client = new \GiftFlow\Vendor\Stripe\StripeClient(['api_key' => 'sk_test_123', 'api_base' => MOCK_URL, 'client_id' => 'ca_123']);
    ...
    {
        $this->setUpService();
        $uriStr = $this->service->authorizeUrl(['scope' => 'read_write', 'state' => 'csrf_token', 'stripe_user' => ['email' => 'test@example.com', 'url' => 'https://example.com/profile/test', 'country' => 'US']]);
    ...
    {
        $this->setUpService();
        $this->stubRequest('POST', '/oauth/token', ['grant_type' => 'authorization_code', 'code' => 'this_is_an_authorization_code', 'client_secret' => 'sk_test_123'], null, false, ['access_token' => 'sk_access_token', 'scope' => 'read_only', 'livemode' => false, 'token_type' => 'bearer', 'refresh_token' => 'sk_refresh_token', 'stripe_user_id' => 'acct_test', 'stripe_publishable_key' => 'pk_test'], 200, $this->client->getConnectBase());
        $resp = $this->client->oauth->token(['grant_type' => 'authorization_code', 'code' => 'this_is_an_authorization_code']);
        self::assertSame('sk_access_token', $resp['access_token']);
    }
    public function testDeauthorize()
    {
        $this->setUpService();
        $this->stubRequest('POST', '/oauth/deauthorize', ['client_id' => 'ca_123', 'stripe_user_id' => 'acct_test'], null, false, ['stripe_user_id' => 'acct_test'], 200, $this->client->getConnectBase());
        $resp = $this->client->oauth->deauthorize(['client_id' => 'ca_123', 'stripe_user_id' => 'acct_test']);
