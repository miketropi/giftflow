 ...
 * @internal
 *
 * @covers \GiftFlow\Vendor\Stripe\Customer
 */
final class CustomerTest extends TestCase
{
    ...
    public function testIsSaveable()
    {
        ...
        $this->expectsRequest('post', '/v1/customers/' . $resource->id);
        $resource->save();
        self::assertInstanceOf(Customer::class, $resource);
    }
    public function testIsUpdatable()
    {
        ...
        $resource = Customer::update(self::TEST_RESOURCE_ID, ['metadata' => ['key' => 'value']]);
        self::assertInstanceOf(Customer::class, $resource);
    }
    public function testIsDeletable()
    {
        $resource = Customer::retrieve(self::TEST_RESOURCE_ID);
        $this->expectsRequest('delete', '/v1/customers/' . $resource->id);
        $resource->delete();
        self::assertInstanceOf(Customer::class, $resource);
    }
    public function testCanDeleteDiscount()
    {
        ...
        $this->stubRequest('delete', '/v1/customers/' . $customer->id . '/discount');
    ...
    {
        /** @var mixed $obj */
        $obj = \GiftFlow\Vendor\Stripe\Util\Util::convertToStripeObject(['object' => 'customer'], null);
        $obj->source = 'tok_visa';
        $expected = ['source' => 'tok_visa'];
    ...
    public function testSerializeSourceMap()
    {
        /** @var mixed $obj */
        $obj = \GiftFlow\Vendor\Stripe\Util\Util::convertToStripeObject(['object' => 'customer'], null);
        $obj->source = ['object' => 'card', 'number' => '4242424242424242', 'exp_month' => 12, 'exp_year' => 2032];
        $expected = ['source' => ['object' => 'card', 'number' => '4242424242424242', 'exp_month' => 12, 'exp_year' => 2032]];
        self::assertSame($expected, $obj->serializeParameters());
    }
    public function testCanCreateTaxId()
    {
        $this->expectsRequest('post', '/v1/customers/' . self::TEST_RESOURCE_ID . '/tax_ids');
        $resource = Customer::createTaxId(self::TEST_RESOURCE_ID, ['type' => TaxId::TYPE_EU_VAT, 'value' => '11111']);
    }
    ...
    public function testCanCreateBalanceTransaction()
    {
        ...
        $resource = Customer::createBalanceTransaction(self::TEST_RESOURCE_ID, ['amount' => 1234, 'currency' => 'usd']);
    }
