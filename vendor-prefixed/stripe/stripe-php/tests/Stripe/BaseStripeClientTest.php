...
use GiftFlow\Vendor\Stripe\Events\UnknownEventNotification;
use GiftFlow\Vendor\Stripe\Events\V1BillingMeterErrorReportTriggeredEventNotification;
use GiftFlow\Vendor\Stripe\Util\ApiVersion;
/**
 * @internal
 *
 * @covers \GiftFlow\Vendor\Stripe\BaseStripeClient
 */
final class BaseStripeClientTest extends TestCase
{
    ...
    {
        $this->curlClientStub = $this->getMockBuilder(\GiftFlow\Vendor\Stripe\HttpClient\CurlClient::class)->setMethods(['executeRequestWithRetries'])->getMock();
    }
    ...
    {
        $this->expectException(\GiftFlow\Vendor\Stripe\Exception\InvalidArgumentException::class);
    ...
    {
        $this->expectException(\GiftFlow\Vendor\Stripe\Exception\AuthenticationException::class);
    ...
    {
        $client = new BaseStripeClient(['api_key' => 'sk_test_client', 'stripe_version' => '2020-03-02', 'api_base' => MOCK_URL]);
        $charge = $client->request('get', '/v1/charges/ch_123', [], []);
        self::assertNotNull($charge);
    ...
    {
        $client = new BaseStripeClient(['api_key' => 'sk_test_client', 'stripe_account' => 'acct_123', 'api_base' => MOCK_URL]);
        $charge = $client->request('get', '/v1/charges/ch_123', [], []);
        self::assertNotNull($charge);
    ...
    {
        $this->expectException(\GiftFlow\Vendor\Stripe\Exception\UnexpectedValueException::class);
    ...
    public function testRequestWithOptsInParamsWarns()
    {
        ...
        $this->expectExceptionMessage('Options found in $params: api_key, stripe_account, api_base. Options should be ' . 'passed in their own array after $params. (HINT: pass an empty array to $params if you do not have any.)');
        $client = new BaseStripeClient(['api_key' => 'sk_test_client', 'stripe_account' => 'acct_123', 'api_base' => MOCK_URL]);
        $charge = $client->request('get', '/v1/charges/ch_123', ['api_key' => 'sk_test_client', 'stripe_account' => 'acct_123', 'api_base' => MOCK_URL], ['stripe_account' => 'acct_456']);
        self::assertNotNull($charge);
        self::assertSame('acct_456', $this->optsReflector->getValue($charge)->headers['Stripe-Account']);
    }
    ...
    {
        $client = new BaseStripeClient(['api_key' => 'sk_test_client', 'api_base' => MOCK_URL]);
        $this->expectsRequest('get', '/v1/charges/ch_123', null, ['Stripe-Version: ' . ApiVersion::CURRENT]);
        $charge = $client->request('get', '/v1/charges/ch_123', [], []);
    }
    public function testJsonRawRequestGetWithURLParams()
    {
        $this->curlClientStub->method('executeRequestWithRetries')->willReturn(['{}', 200, []]);
        $opts = null;
        $this->curlClientStub->expects(self::once())->method('executeRequestWithRetries')->with(self::callback(static function ($opts_) use (&$opts) {
            $opts = $opts_;
            return true;
    ...
    {
        $this->curlClientStub->method('executeRequestWithRetries')->willReturn(['{}', 200, ['request-id' => 'req_123']]);
        $this->curlClientStub->expects(self::once())->method('executeRequestWithRetries')->with(self::callback(static function ($opts) {
            return true;
        }), MOCK_URL . '/v1/xyz');
        ApiRequestor::setHttpClient($this->curlClientStub);
        $client = new BaseStripeClient(['api_key' => 'sk_test_client', 'api_base' => MOCK_URL]);
    ...
    {
        $this->curlClientStub->method('executeRequestWithRetries')->willReturn(['{"object": "xyz", "isPHPBestLanguage": true, "abc": {"object": "abc", "a": 2}}', 200, []]);
        $this->curlClientStub->expects(self::once())->method('executeRequestWithRetries')->with(self::callback(function ($opts) {
        ...
        self::assertSame('xyz', $xyz->object);
        // @phpstan-ignore-line
        self::assertTrue($xyz->isPHPBestLanguage);
        // @phpstan-ignore-line
        self::assertSame(2, $xyz->abc->a);
        // @phpstan-ignore-line
        self::assertInstanceof(StripeObject::class, $xyz->abc);
        // @phpstan-ignore-line
    }
    ...
    public function testRawRequestWithStripeContextOption()
    {
        ...
        $client = new BaseStripeClient(['api_key' => 'sk_test_client', 'stripe_account' => 'acct_123', 'api_base' => MOCK_URL]);
        $params = [];
        $client->rawRequest('post', '/v2/xyz', $params, ['stripe_context' => 'acct_456']);
    }
    public function testReqOverridesClientContext()
    {
        ...
        ApiRequestor::setHttpClient($this->curlClientStub);
        $client = new BaseStripeClient(['api_key' => 'sk_test_client', 'stripe_context' => new StripeContext(['acct_123']), 'api_base' => MOCK_URL]);
        $params = [];
    ...
    {
        $this->curlClientStub->method('executeRequestWithRetries')->willReturn(['{"object": "v2.billing.meter_event_session"}', 200, []]);
        $this->curlClientStub->expects(self::once())->method('executeRequestWithRetries')->with(self::callback(function ($opts) {
        ...
        ApiRequestor::setHttpClient($this->curlClientStub);
        $client = new BaseStripeClient(['api_key' => 'sk_test_client', 'stripe_version' => '2222-22-22.preview-v2', 'api_base' => MOCK_URL]);
        $meterEventSession = $client->request('get', '/v2/billing/meter_event_session', [], []);
        self::assertNotNull($meterEventSession);
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\V2\Billing\MeterEventSession::class, $meterEventSession);
    }
    public function testV2GetRequestUnsetContext()
    {
        ...
        ApiRequestor::setHttpClient($this->curlClientStub);
        $client = new BaseStripeClient(['api_key' => 'sk_test_client', 'stripe_version' => '2222-22-22.preview-v2', 'api_base' => MOCK_URL, 'stripe_context' => new StripeContext(['acct_123'])]);
        $meterEventSession = $client->request('get', '/v2/billing/meter_event_session', [], ['stripe_context' => new StripeContext()]);
        self::assertNotNull($meterEventSession);
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\V2\Billing\MeterEventSession::class, $meterEventSession);
    }
    public function testV2GetRequestOverwritesContext()
    {
        ...
        ApiRequestor::setHttpClient($this->curlClientStub);
        $client = new BaseStripeClient(['api_key' => 'sk_test_client', 'stripe_version' => '2222-22-22.preview-v2', 'api_base' => MOCK_URL, 'stripe_context' => new StripeContext(['acct_123'])]);
        $meterEventSession = $client->request('get', '/v2/billing/meter_event_session', [], ['stripe_context' => new StripeContext(['acct_456'])]);
        self::assertNotNull($meterEventSession);
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\V2\Billing\MeterEventSession::class, $meterEventSession);
    }
    ...
    {
        $this->curlClientStub->method('executeRequestWithRetries')->willReturn(['{"object": "account"}', 200, []]);
        $this->curlClientStub->expects(self::once())->method('executeRequestWithRetries')->with(self::callback(function ($opts) {
            $this->assertContains('Stripe-Context: acct_123', $opts[\CURLOPT_HTTPHEADER]);
            return true;
        }), MOCK_URL . '/v2/accounts');
        ApiRequestor::setHttpClient($this->curlClientStub);
        $client = new BaseStripeClient(['api_key' => 'sk_test_client', 'stripe_context' => 'acct_123', 'api_base' => MOCK_URL]);
    ...
    {
        $curlClientStub = $this->getMockBuilder(\GiftFlow\Vendor\Stripe\HttpClient\CurlClient::class)->setMethods(['executeRequestWithRetries'])->getMock();
        $curlClientStub->method('executeRequestWithRetries')->willReturn(['{"object": "charge"}', 200, []]);
        $curlClientStub->expects(self::once())->method('executeRequestWithRetries')->with(self::callback(function ($opts) {
            $this->assertAppInfo('User-Agent: Stripe/v1 PhpBindings/' . Stripe::VERSION . ' MyTestApp/1.2.34 (https://mytestapp.example)', '{"name": "MyTestApp","version":"1.2.34","url":"https://mytestapp.example","partner_id":"partner_1234"}', $opts[\CURLOPT_HTTPHEADER]);
            return true;
        }), MOCK_URL . '/v1/charges/ch_123');
        $appInfo = ['name' => 'MyTestApp', 'version' => '1.2.34', 'url' => 'https://mytestapp.example', 'partner_id' => 'partner_1234'];
        ApiRequestor::setHttpClient($curlClientStub);
        $client = new BaseStripeClient(['api_key' => 'sk_test_appinfo', 'api_base' => MOCK_URL, 'app_info' => $appInfo]);
    ...
    public function testSetClientAppInfoOnlyName()
    {
        ...
        $curlClientStub->method('executeRequestWithRetries')->willReturn(['{"object": "charge"}', 200, []]);
        $curlClientStub->expects(self::once())->method('executeRequestWithRetries')->with(self::callback(function ($opts) {
            $this->assertAppInfo('User-Agent: Stripe/v1 PhpBindings/' . Stripe::VERSION . ' MyTestApp', '{"name": "MyTestApp"}', $opts[\CURLOPT_HTTPHEADER]);
            return true;
        }), MOCK_URL . '/v1/charges/ch_123');
        ApiRequestor::setHttpClient($curlClientStub);
        $client = new BaseStripeClient(['api_key' => 'sk_test_appinfo', 'api_base' => MOCK_URL, 'app_info' => ['name' => 'MyTestApp']]);
        $client->request('get', '/v1/charges/ch_123', [], []);
    }
    public function testClientAppInfoFallsBackToGlobal()
    {
        ...
        $curlClientStub->method('executeRequestWithRetries')->willReturn(['{"object": "charge"}', 200, []]);
        $curlClientStub->expects(self::once())->method('executeRequestWithRetries')->with(self::callback(function ($opts) {
            $this->assertAppInfo('User-Agent: Stripe/v1 PhpBindings/' . Stripe::VERSION . ' MyTestApp/1.2.34 (https://mytestapp.example)', '{"name": "MyTestApp","version":"1.2.34","url":"https://mytestapp.example"}', $opts[\CURLOPT_HTTPHEADER]);
            return true;
        }), MOCK_URL . '/v1/charges/ch_123');
        ApiRequestor::setHttpClient($curlClientStub);
        Stripe::setAppInfo('MyTestApp', '1.2.34', 'https://mytestapp.example');
        $client = new BaseStripeClient(['api_key' => 'sk_test_appinfo', 'api_base' => MOCK_URL]);
        $client->request('get', '/v1/charges/ch_123', [], []);
    }
    public function testClientAppInfoOverridesGlobal()
    {
        ...
        $curlClientStub->expects(self::once())->method('executeRequestWithRetries')->with(self::callback(function ($opts) {
            ...
            $this->assertAppInfo('User-Agent: Stripe/v1 PhpBindings/' . Stripe::VERSION . ' MyTestApp/2.3.45 (https://mytestapp.example)', '{"name": "MyTestApp","version":"2.3.45","url":"https://mytestapp.example"}', $opts[\CURLOPT_HTTPHEADER]);
            return true;
        }), MOCK_URL . '/v1/charges/ch_123');
        ApiRequestor::setHttpClient($curlClientStub);
        Stripe::setAppInfo('NotMyTestApp', '1.2.34', 'https://notmytestapp.example');
        $client = new BaseStripeClient(['api_key' => 'sk_test_appinfo', 'api_base' => MOCK_URL, 'app_info' => ['name' => 'MyTestApp', 'version' => '2.3.45', 'url' => 'https://mytestapp.example']]);
        $client->request('get', '/v1/charges/ch_123', [], []);
    }
    public function testConfigValidationFindsExtraAppInfoKeys()
    {
        $this->expectException(\GiftFlow\Vendor\Stripe\Exception\InvalidArgumentException::class);
        $client = new BaseStripeClient(['api_key' => 'sk_test_appinfo', 'app_info' => ['name' => 'MyTestApp', 'foo' => 'bar']]);
    }
    public function testParseEventNotification()
    {
        $jsonEvent = ['id' => 'evt_234', 'object' => 'event', 'type' => 'v1.billing.meter.error_report_triggered', 'created' => '2022-02-15T00:27:45.330Z', 'context' => 'acct_123', 'livemode' => false, 'related_object' => ['id' => 'meter_123', 'type' => 'billing.meter', 'url' => '/v1/financial_accounts/meter_123']];
    ...
    {
        $jsonEvent = ['id' => 'evt_234', 'object' => 'event', 'type' => 'imaginary', 'livemode' => true, 'created' => '2022-02-15T00:27:45.330Z'];
        $eventData = json_encode($jsonEvent);
        $client = new BaseStripeClient(['api_key' => 'sk_test_client', 'api_base' => MOCK_URL, 'stripe_account' => 'acc_123']);
        $sigHeader = WebhookTest::generateHeader(['payload' => $eventData]);
        $event = $client->parseEventNotification($eventData, $sigHeader, WebhookTest::SECRET);
    ...
    public function testV2OverridesPreviewVersionIfPassedInRawRequestOptions()
    {
        ...
        $client = new BaseStripeClient(['api_key' => 'sk_test_client', 'api_base' => MOCK_URL]);
        $params = [];
        $client->rawRequest('post', '/v2/accounts/acct_123', $params, ['stripe_version' => '2222-22-22.preview-v2']);
    }
    ...
    {
        $this->curlClientStub->method('executeRequestWithRetries')->willReturnOnConsecutiveCalls(['{"object": "v2.billing.meter_event_session"}', 200, []], ['{"object": "billing.meter_event"}', 200, []]);
        $this->curlClientStub->method('executeRequestWithRetries')->withConsecutive([self::callback(function ($opts) {
            $this->assertContains('Stripe-Version: ' . ApiVersion::CURRENT, $opts[\CURLOPT_HTTPHEADER]);
            return true;
        }), MOCK_URL . '/v2/billing/meter_event_session/bmes_123'], [self::callback(function ($opts) {
            $this->assertContains('Stripe-Version: ' . ApiVersion::CURRENT, $opts[\CURLOPT_HTTPHEADER]);
            return true;
        ...
        self::assertInstanceOf(\GiftFlow\Vendor\Stripe\Billing\MeterEvent::class, $meterEvent);
    }
