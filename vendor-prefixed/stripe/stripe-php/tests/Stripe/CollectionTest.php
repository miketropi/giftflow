...
final class CollectionTest extends TestCase
{
    ...
    {
        $this->fixture = Collection::constructFrom(['data' => [['id' => '1']], 'has_more' => true, 'url' => '/things']);
    }
    ...
    {
        $this->stubRequest('GET', '/things', [], null, false, ['object' => 'list', 'data' => [['id' => '1']], 'has_more' => true, 'url' => '/things']);
        $resources = $this->fixture->all();
        self::compatAssertIsArray($resources->data);
    }
    public function testCanRetrieve()
    {
        $this->stubRequest('GET', '/things/1', [], null, false, ['id' => '1']);
        $this->fixture->retrieve('1');
    }
    public function testCanCreate()
    {
        $this->stubRequest('POST', '/things', ['foo' => 'bar'], null, false, ['id' => '2']);
        $this->fixture->create(['foo' => 'bar']);
    }
    ...
    {
        $collection = Collection::constructFrom(['data' => [['id' => '1'], ['id' => '2'], ['id' => '3']], 'has_more' => true, 'url' => '/things']);
        $seen = [];
    ...
    {
        $this->stubRequest('GET', '/things', ['starting_after' => '1'], null, false, ['object' => 'list', 'data' => [['id' => '2'], ['id' => '3']], 'has_more' => false]);
        $seen = [];
    ...
    {
        $this->stubRequest('GET', '/things', ['ending_before' => '3'], null, false, ['object' => 'list', 'data' => [['id' => '1'], ['id' => '2']], 'has_more' => false]);
        $collection = Collection::constructFrom(['data' => [['id' => '3']], 'has_more' => true, 'url' => '/things']);
    ...
    {
        $this->stubRequest('POST', '/things', ['foo' => 'bar'], ['Stripe-Account: acct_foo', 'Idempotency-Key: qwertyuiop'], false, ['id' => '2']);
        $this->fixture->create(['foo' => 'bar'], ['stripe_account' => 'acct_foo', 'idempotency_key' => 'qwertyuiop']);
    }
    ...
    {
        $this->stubRequest('GET', '/things', ['ending_before' => '1'], null, false, ['object' => 'list', 'data' => [], 'has_more' => false]);
        $previousPage = $this->fixture->previousPage();
        self::assertSame([], $previousPage->data);
    }
    public function testFirst()
    {
        $collection = Collection::constructFrom(['data' => [['content' => 'first'], ['content' => 'middle'], ['content' => 'last']]]);
