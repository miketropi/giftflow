 ...
 * @property (object{billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\GiftFlow\Vendor\Stripe\StripeObject), email: null|string, name: null|string}&\GiftFlow\Vendor\Stripe\StripeObject), financial_account?: (object{id: string, network: string}&\GiftFlow\Vendor\Stripe\StripeObject), type: string, us_bank_account?: (object{account_holder_type: null|string, account_type: null|string, bank_name: null|string, fingerprint: null|string, last4: null|string, mandate?: string|\GiftFlow\Vendor\Stripe\Mandate, network: string, routing_number: null|string}&\GiftFlow\Vendor\Stripe\StripeObject)}&\GiftFlow\Vendor\Stripe\StripeObject) $destination_payment_method_details
 ...
 * @property null|(object{code: string, transaction: string|Transaction}&\GiftFlow\Vendor\Stripe\StripeObject) $returned_details Details about a returned OutboundTransfer. Only set when the status is <code>returned</code>.
 ...
 */
class OutboundTransfer extends \GiftFlow\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<OutboundTransfer> of ApiResources
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
