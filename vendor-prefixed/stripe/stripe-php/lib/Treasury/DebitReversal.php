 ...
 * @property null|(object{issuing_dispute: null|string}&\GiftFlow\Vendor\Stripe\StripeObject) $linked_flows Other flows linked to a DebitReversal.
 ...
 * @property (object{completed_at: null|int}&\GiftFlow\Vendor\Stripe\StripeObject) $status_transitions
 * @property null|string|Transaction $transaction The Transaction associated with this object.
 */
class DebitReversal extends \GiftFlow\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<DebitReversal> of ApiResources
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
