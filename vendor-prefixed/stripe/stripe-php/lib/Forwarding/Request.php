...
namespace GiftFlow\Vendor\Stripe\Forwarding;
 ...
 * @property null|(object{destination_duration: int, destination_ip_address: string}&\GiftFlow\Vendor\Stripe\StripeObject) $request_context Context about the request from Stripe's servers to the destination endpoint.
 * @property null|(object{body: string, headers: (object{name: string, value: string}&\GiftFlow\Vendor\Stripe\StripeObject)[], http_method: string}&\GiftFlow\Vendor\Stripe\StripeObject) $request_details The request that was sent to the destination endpoint. We redact any sensitive fields.
 * @property null|(object{body: string, headers: (object{name: string, value: string}&\GiftFlow\Vendor\Stripe\StripeObject)[], status: int}&\GiftFlow\Vendor\Stripe\StripeObject) $response_details The response that the destination endpoint returned to us. We redact any sensitive fields.
 * @property null|string $url The destination URL for the forwarded request. Must be supported by the config.
 */
class Request extends \GiftFlow\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<Request> of ApiResources
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
