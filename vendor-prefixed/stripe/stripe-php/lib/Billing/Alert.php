 ...
 * @property null|(object{filters: null|((object{customer: null|string|\GiftFlow\Vendor\Stripe\Customer, type: string}&\GiftFlow\Vendor\Stripe\StripeObject))[], gte: int, meter: Meter|string, recurrence: string}&\GiftFlow\Vendor\Stripe\StripeObject) $usage_threshold Encapsulates configuration of the alert to monitor usage on a specific <a href="https://docs.stripe.com/api/billing/meter">Billing Meter</a>.
 */
class Alert extends \GiftFlow\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<Alert> of ApiResources
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
