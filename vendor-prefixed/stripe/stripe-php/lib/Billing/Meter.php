 ...
 * @property (object{event_payload_key: string, type: string}&\GiftFlow\Vendor\Stripe\StripeObject) $customer_mapping
 * @property (object{formula: string}&\GiftFlow\Vendor\Stripe\StripeObject) $default_aggregation
 ...
 * @property (object{deactivated_at: null|int}&\GiftFlow\Vendor\Stripe\StripeObject) $status_transitions
 * @property int $updated Time at which the object was last updated. Measured in seconds since the Unix epoch.
 * @property (object{event_payload_key: string}&\GiftFlow\Vendor\Stripe\StripeObject) $value_settings
 */
class Meter extends \GiftFlow\Vendor\Stripe\ApiResource
{
    const OBJECT_NAME = 'billing.meter';
    use \GiftFlow\Vendor\Stripe\ApiOperations\NestedResource;
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<Meter> of ApiResources
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|array|string $opts
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<MeterEventSummary> the list of meter event summaries
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
