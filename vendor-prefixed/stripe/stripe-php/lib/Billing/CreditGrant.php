 ...
 * @property (object{monetary: null|(object{currency: string, value: int}&\GiftFlow\Vendor\Stripe\StripeObject), type: string}&\GiftFlow\Vendor\Stripe\StripeObject) $amount
 * @property (object{scope: (object{price_type?: string, prices?: ((object{id: null|string}&\GiftFlow\Vendor\Stripe\StripeObject))[]}&\GiftFlow\Vendor\Stripe\StripeObject)}&\GiftFlow\Vendor\Stripe\StripeObject) $applicability_config
 ...
 * @property string|\GiftFlow\Vendor\Stripe\Customer $customer ID of the customer receiving the billing credits.
 ...
 * @property null|string|\GiftFlow\Vendor\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this credit grant belongs to.
 ...
 */
class CreditGrant extends \GiftFlow\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<CreditGrant> of ApiResources
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
