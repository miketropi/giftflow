 ...
 * @property null|(object{collect_inputs?: (object{inputs: ((object{custom_text: null|(object{description: null|string, skip_button: null|string, submit_button: null|string, title: null|string}&\GiftFlow\Vendor\Stripe\StripeObject), email?: (object{value: null|string}&\GiftFlow\Vendor\Stripe\StripeObject), numeric?: (object{value: null|string}&\GiftFlow\Vendor\Stripe\StripeObject), phone?: (object{value: null|string}&\GiftFlow\Vendor\Stripe\StripeObject), required: null|bool, selection?: (object{choices: ((object{id: null|string, style: null|string, text: string}&\GiftFlow\Vendor\Stripe\StripeObject))[], id: null|string, text: null|string}&\GiftFlow\Vendor\Stripe\StripeObject), signature?: (object{value: null|string}&\GiftFlow\Vendor\Stripe\StripeObject), skipped?: bool, text?: (object{value: null|string}&\GiftFlow\Vendor\Stripe\StripeObject), toggles: null|((object{default_value: null|string, description: null|string, title: null|string, value: null|string}&\GiftFlow\Vendor\Stripe\StripeObject))[], type: string}&\GiftFlow\Vendor\Stripe\StripeObject))[], metadata: null|\GiftFlow\Vendor\Stripe\StripeObject}&\GiftFlow\Vendor\Stripe\StripeObject), collect_payment_method?: (object{collect_config?: (object{enable_customer_cancellation?: bool, skip_tipping?: bool, tipping?: (object{amount_eligible?: int}&\GiftFlow\Vendor\Stripe\StripeObject)}&\GiftFlow\Vendor\Stripe\StripeObject), payment_intent: string|\GiftFlow\Vendor\Stripe\PaymentIntent, payment_method?: \GiftFlow\Vendor\Stripe\PaymentMethod}&\GiftFlow\Vendor\Stripe\StripeObject), confirm_payment_intent?: (object{confirm_config?: (object{return_url?: string}&\GiftFlow\Vendor\Stripe\StripeObject), payment_intent: string|\GiftFlow\Vendor\Stripe\PaymentIntent}&\GiftFlow\Vendor\Stripe\StripeObject), failure_code: null|string, failure_message: null|string, process_payment_intent?: (object{payment_intent: string|\GiftFlow\Vendor\Stripe\PaymentIntent, process_config?: (object{enable_customer_cancellation?: bool, return_url?: string, skip_tipping?: bool, tipping?: (object{amount_eligible?: int}&\GiftFlow\Vendor\Stripe\StripeObject)}&\GiftFlow\Vendor\Stripe\StripeObject)}&\GiftFlow\Vendor\Stripe\StripeObject), process_setup_intent?: (object{generated_card?: string, process_config?: (object{enable_customer_cancellation?: bool}&\GiftFlow\Vendor\Stripe\StripeObject), setup_intent: string|\GiftFlow\Vendor\Stripe\SetupIntent}&\GiftFlow\Vendor\Stripe\StripeObject), refund_payment?: (object{amount?: int, charge?: string|\GiftFlow\Vendor\Stripe\Charge, metadata?: \GiftFlow\Vendor\Stripe\StripeObject, payment_intent?: string|\GiftFlow\Vendor\Stripe\PaymentIntent, reason?: string, refund?: string|\GiftFlow\Vendor\Stripe\Refund, refund_application_fee?: bool, refund_payment_config?: (object{enable_customer_cancellation?: bool}&\GiftFlow\Vendor\Stripe\StripeObject), reverse_transfer?: bool}&\GiftFlow\Vendor\Stripe\StripeObject), set_reader_display?: (object{cart: null|(object{currency: string, line_items: (object{amount: int, description: string, quantity: int}&\GiftFlow\Vendor\Stripe\StripeObject)[], tax: null|int, total: int}&\GiftFlow\Vendor\Stripe\StripeObject), type: string}&\GiftFlow\Vendor\Stripe\StripeObject), status: string, type: string}&\GiftFlow\Vendor\Stripe\StripeObject) $action The most recent action performed by the reader.
 ...
 */
class Reader extends \GiftFlow\Vendor\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<Reader> of ApiResources
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
