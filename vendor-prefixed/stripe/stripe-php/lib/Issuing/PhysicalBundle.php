 ...
 * @property (object{card_logo: string, carrier_text: string, second_line: string}&\GiftFlow\Vendor\Stripe\StripeObject) $features
 ...
 */
class PhysicalBundle extends \GiftFlow\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<PhysicalBundle> of ApiResources
     *
