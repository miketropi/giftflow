 ...
 * @property (object{address: null|(object{city: null|string, country: string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\GiftFlow\Vendor\Stripe\StripeObject), address_source: null|string, ip_address: null|string, tax_ids: (object{type: string, value: string}&\GiftFlow\Vendor\Stripe\StripeObject)[], taxability_override: string}&\GiftFlow\Vendor\Stripe\StripeObject) $customer_details
 * @property null|int $expires_at Timestamp of date at which the tax calculation will expire.
 * @property null|\GiftFlow\Vendor\Stripe\Collection<CalculationLineItem> $line_items The list of items the customer is purchasing.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|(object{address: (object{city: null|string, country: string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\GiftFlow\Vendor\Stripe\StripeObject)}&\GiftFlow\Vendor\Stripe\StripeObject) $ship_from_details The details of the ship from location, such as the address.
 * @property null|(object{amount: int, amount_tax: int, shipping_rate?: string, tax_behavior: string, tax_breakdown?: ((object{amount: int, jurisdiction: (object{country: string, display_name: string, level: string, state: null|string}&\GiftFlow\Vendor\Stripe\StripeObject), sourcing: string, tax_rate_details: null|(object{display_name: string, percentage_decimal: string, tax_type: string}&\GiftFlow\Vendor\Stripe\StripeObject), taxability_reason: string, taxable_amount: int}&\GiftFlow\Vendor\Stripe\StripeObject))[], tax_code: string}&\GiftFlow\Vendor\Stripe\StripeObject) $shipping_cost The shipping cost details for the calculation.
 ...
 * @property ((object{amount: int, inclusive: bool, tax_rate_details: (object{country: null|string, flat_amount: null|(object{amount: int, currency: string}&\GiftFlow\Vendor\Stripe\StripeObject), percentage_decimal: string, rate_type: null|string, state: null|string, tax_type: null|string}&\GiftFlow\Vendor\Stripe\StripeObject), taxability_reason: string, taxable_amount: int}&\GiftFlow\Vendor\Stripe\StripeObject))[] $tax_breakdown Breakdown of individual tax amounts that add up to the total.
 * @property int $tax_date Timestamp of date at which the tax rules and rates in effect applies for the calculation.
 */
class Calculation extends \GiftFlow\Vendor\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<CalculationLineItem> list of calculation line items
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
