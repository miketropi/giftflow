 ...
 * @property (object{provider: string, tax_behavior: null|string, tax_code: null|string}&\GiftFlow\Vendor\Stripe\StripeObject) $defaults
 * @property null|(object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\GiftFlow\Vendor\Stripe\StripeObject)}&\GiftFlow\Vendor\Stripe\StripeObject) $head_office The place where your business is located.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property string $status The status of the Tax <code>Settings</code>.
 * @property (object{active?: (object{}&\GiftFlow\Vendor\Stripe\StripeObject), pending?: (object{missing_fields: null|string[]}&\GiftFlow\Vendor\Stripe\StripeObject)}&\GiftFlow\Vendor\Stripe\StripeObject) $status_details
 */
class Settings extends \GiftFlow\Vendor\Stripe\SingletonApiResource
{
