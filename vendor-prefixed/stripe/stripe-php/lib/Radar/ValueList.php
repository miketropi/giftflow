 ...
 * @property \GiftFlow\Vendor\Stripe\Collection<ValueListItem> $list_items List of items contained within this value list.
 ...
 */
class ValueList extends \GiftFlow\Vendor\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<ValueList> of ApiResources
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
