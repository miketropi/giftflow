...
namespace GiftFlow\Vendor\Stripe\TestHelpers;
 ...
 * @property (object{advancing?: (object{target_frozen_time: int}&\GiftFlow\Vendor\Stripe\StripeObject)}&\GiftFlow\Vendor\Stripe\StripeObject) $status_details
 */
class TestClock extends \GiftFlow\Vendor\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<TestClock> of ApiResources
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
