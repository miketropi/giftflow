 ...
 * @property null|(object{message: string}&\GiftFlow\Vendor\Stripe\StripeObject) $error
 * @property null|\GiftFlow\Vendor\Stripe\File $file The file object representing the results of the query.
 ...
 */
class ScheduledQueryRun extends \GiftFlow\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<ScheduledQueryRun> of ApiResources
     *
