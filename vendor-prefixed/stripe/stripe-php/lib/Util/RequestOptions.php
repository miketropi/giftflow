...
/**
 * @phpstan-type RequestOptionsArray array{api_key?: string, idempotency_key?: string, stripe_account?: string, stripe_context?: string|\GiftFlow\Vendor\Stripe\StripeContext, stripe_version?: string, api_base?: string, max_network_retries?: int }
 *
 * @psalm-type RequestOptionsArray = array{api_key?: string, idempotency_key?: string, stripe_account?: string, stripe_context?: string|\GiftFlow\Vendor\Stripe\StripeContext, stripe_version?: string, api_base?: string, max_network_retries?: int }
 */
