...
abstract class ApiErrorException extends \Exception implements ExceptionInterface
{
     ...
     * @param null|array|\GiftFlow\Vendor\Stripe\Util\CaseInsensitiveArray $httpHeaders the HTTP headers array
     ...
     *
     * @return null|\GiftFlow\Vendor\Stripe\ErrorObject
     */
     ...
     *
     * @param null|\GiftFlow\Vendor\Stripe\ErrorObject $error
     */
     ...
     *
     * @return null|array|\GiftFlow\Vendor\Stripe\Util\CaseInsensitiveArray
     */
     ...
     *
     * @param null|array|\GiftFlow\Vendor\Stripe\Util\CaseInsensitiveArray $httpHeaders
     */
    ...
    protected function constructErrorObject()
    {
        ...
        return \GiftFlow\Vendor\Stripe\ErrorObject::constructFrom($this->jsonBody['error']);
    }
}
