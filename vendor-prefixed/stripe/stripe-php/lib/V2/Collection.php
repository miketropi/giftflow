 ...
 */
class Collection extends \GiftFlow\Vendor\Stripe\StripeObject implements \Countable, \IteratorAggregate
{
    const OBJECT_NAME = 'list';
    use \GiftFlow\Vendor\Stripe\ApiOperations\Request;
    /**
     * @return string the base URL for the given class
     */
    public static function baseUrl()
    {
        return \GiftFlow\Vendor\Stripe\Stripe::$apiBase;
    }
    /**
     * @return mixed
     */
    ...
    public function offsetGet($k)
    {
        ...
        throw new \GiftFlow\Vendor\Stripe\Exception\InvalidArgumentException($msg);
    }
    /**
     ...
     *    continued iteration.
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException
     */
    public function autoPagingIterator()
    {
        ...
        while (true) {
            ...
            $obj = \GiftFlow\Vendor\Stripe\Util\Util::convertToStripeObject($response, $opts, 'v2');
