 ...
 * @property (object{identifier: string}&\GiftFlow\Vendor\Stripe\StripeObject) $cancel Specifies which event to cancel.
 ...
 */
class MeterEventAdjustment extends \GiftFlow\Vendor\Stripe\ApiResource
{
