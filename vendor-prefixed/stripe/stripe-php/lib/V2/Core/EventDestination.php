 ...
 * @property null|(object{aws_account_id: string, aws_event_source_arn: string, aws_event_source_status: string}&\GiftFlow\Vendor\Stripe\StripeObject) $amazon_eventbridge Amazon EventBridge configuration.
 ...
 * @property null|\GiftFlow\Vendor\Stripe\StripeObject $metadata Metadata.
 ...
 * @property null|(object{disabled?: (object{reason: string}&\GiftFlow\Vendor\Stripe\StripeObject)}&\GiftFlow\Vendor\Stripe\StripeObject) $status_details Additional information about event destination status.
 * @property string $type Event destination type.
 * @property int $updated Time at which the object was last updated.
 * @property null|(object{signing_secret?: string, url?: string}&\GiftFlow\Vendor\Stripe\StripeObject) $webhook_endpoint Webhook endpoint configuration.
 */
class EventDestination extends \GiftFlow\Vendor\Stripe\ApiResource
{
