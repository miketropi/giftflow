 ...
 * @property (object{type: string, account_onboarding?: (object{collection_options?: (object{fields?: string, future_requirements?: string}&\GiftFlow\Vendor\Stripe\StripeObject), configurations: string[], refresh_url: string, return_url?: string}&\GiftFlow\Vendor\Stripe\StripeObject), account_update?: (object{collection_options?: (object{fields?: string, future_requirements?: string}&\GiftFlow\Vendor\Stripe\StripeObject), configurations: string[], refresh_url: string, return_url?: string}&\GiftFlow\Vendor\Stripe\StripeObject)}&\GiftFlow\Vendor\Stripe\StripeObject) $use_case Hash containing usage options.
 */
class AccountLink extends \GiftFlow\Vendor\Stripe\ApiResource
{
