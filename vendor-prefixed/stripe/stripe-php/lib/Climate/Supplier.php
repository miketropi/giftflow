 ...
 * @property ((object{city: null|string, country: string, latitude: null|float, longitude: null|float, region: null|string}&\GiftFlow\Vendor\Stripe\StripeObject))[] $locations The locations in which this supplier operates.
 ...
 */
class Supplier extends \GiftFlow\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<Supplier> of ApiResources
     *
