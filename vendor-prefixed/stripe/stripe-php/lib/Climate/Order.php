...
namespace GiftFlow\Vendor\Stripe\Climate;
 ...
 * @property null|(object{public_name: string}&\GiftFlow\Vendor\Stripe\StripeObject) $beneficiary
 ...
 * @property ((object{delivered_at: int, location: null|(object{city: null|string, country: string, latitude: null|float, longitude: null|float, region: null|string}&\GiftFlow\Vendor\Stripe\StripeObject), metric_tons: string, registry_url: null|string, supplier: Supplier}&\GiftFlow\Vendor\Stripe\StripeObject))[] $delivery_details Details about the delivery of carbon removal for this order.
 ...
 */
class Order extends \GiftFlow\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<Order> of ApiResources
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
