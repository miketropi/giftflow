 ...
 */
class ScheduledQueryRunService extends \GiftFlow\Vendor\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<\GiftFlow\Vendor\Stripe\Sigma\ScheduledQueryRun>
     *
     ...
     * @param null|RequestOptionsArray|\GiftFlow\Vendor\Stripe\Util\RequestOptions $opts
     *
     * @return \GiftFlow\Vendor\Stripe\Sigma\ScheduledQueryRun
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
