...
class EphemeralKeyService extends AbstractService
{
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\EphemeralKey
     *
    ...
    public function create($params = null, $opts = null)
    {
        if (!$opts || !isset($opts['stripe_version'])) {
            throw new \GiftFlow\Vendor\Stripe\Exception\InvalidArgumentException('stripe_version must be specified to create an ephemeral key');
        }
