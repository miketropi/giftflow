...
class CoreServiceFactory extends AbstractServiceFactory
{
    ...
    private static $classMap = [
        ...
        'apps' => \GiftFlow\Vendor\Stripe\Service\Apps\AppsServiceFactory::class,
        ...
        'billing' => \GiftFlow\Vendor\Stripe\Service\Billing\BillingServiceFactory::class,
        'billingPortal' => \GiftFlow\Vendor\Stripe\Service\BillingPortal\BillingPortalServiceFactory::class,
        'charges' => ChargeService::class,
        'checkout' => \GiftFlow\Vendor\Stripe\Service\Checkout\CheckoutServiceFactory::class,
        'climate' => \GiftFlow\Vendor\Stripe\Service\Climate\ClimateServiceFactory::class,
        ...
        'entitlements' => \GiftFlow\Vendor\Stripe\Service\Entitlements\EntitlementsServiceFactory::class,
        ...
        'financialConnections' => \GiftFlow\Vendor\Stripe\Service\FinancialConnections\FinancialConnectionsServiceFactory::class,
        'forwarding' => \GiftFlow\Vendor\Stripe\Service\Forwarding\ForwardingServiceFactory::class,
        'identity' => \GiftFlow\Vendor\Stripe\Service\Identity\IdentityServiceFactory::class,
        ...
        'issuing' => \GiftFlow\Vendor\Stripe\Service\Issuing\IssuingServiceFactory::class,
        ...
        'radar' => \GiftFlow\Vendor\Stripe\Service\Radar\RadarServiceFactory::class,
        'refunds' => RefundService::class,
        'reporting' => \GiftFlow\Vendor\Stripe\Service\Reporting\ReportingServiceFactory::class,
        ...
        'sigma' => \GiftFlow\Vendor\Stripe\Service\Sigma\SigmaServiceFactory::class,
        ...
        'tax' => \GiftFlow\Vendor\Stripe\Service\Tax\TaxServiceFactory::class,
        'taxCodes' => TaxCodeService::class,
        'taxIds' => TaxIdService::class,
        'taxRates' => TaxRateService::class,
        'terminal' => \GiftFlow\Vendor\Stripe\Service\Terminal\TerminalServiceFactory::class,
        'testHelpers' => \GiftFlow\Vendor\Stripe\Service\TestHelpers\TestHelpersServiceFactory::class,
        'tokens' => TokenService::class,
        'topups' => TopupService::class,
        'transfers' => TransferService::class,
        'treasury' => \GiftFlow\Vendor\Stripe\Service\Treasury\TreasuryServiceFactory::class,
        'v2' => \GiftFlow\Vendor\Stripe\Service\V2\V2ServiceFactory::class,
