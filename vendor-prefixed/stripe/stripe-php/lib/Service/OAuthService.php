...
class OAuthService extends AbstractService
{
     ...
     * @param array|\GiftFlow\Vendor\Stripe\Util\RequestOptions $opts the special modifiers of the request
     *
     * @return \GiftFlow\Vendor\Stripe\StripeObject the object returned by Stripe's Connect API
     */
    ...
    public function authorizeUrl($params = null, $opts = null)
    {
        ...
        $query = \GiftFlow\Vendor\Stripe\Util\Util::encodeParameters($params);
     ...
     * @param null|array $opts
     *
     * @return \GiftFlow\Vendor\Stripe\StripeObject object containing the response from the API
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\OAuth\OAuthErrorException if the request fails
     */
    ...
    private function _getClientId($params = null)
    {
        ...
        if (null === $clientId) {
            $msg = 'No client_id provided. (HINT: set your client_id using '
              . '`new \GiftFlow\Vendor\Stripe\StripeClient([clientId => <CLIENT-ID>
            ...
            throw new \GiftFlow\Vendor\Stripe\Exception\AuthenticationException($msg);
        }
     ...
     * @param array|\GiftFlow\Vendor\Stripe\Util\RequestOptions $opts the special modifiers of the request
     *
     * @return \GiftFlow\Vendor\Stripe\Util\RequestOptions
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\InvalidArgumentException
     */
    private function _parseOpts($opts)
    {
        if (\is_array($opts)) {
            if (\array_key_exists('connect_base', $opts)) {
                ...
                throw new \GiftFlow\Vendor\Stripe\Exception\InvalidArgumentException('Use `api_base`, not `connect_base`');
            }
        }

        return \GiftFlow\Vendor\Stripe\Util\RequestOptions::parse($opts);
    }

    /**
     * @param \GiftFlow\Vendor\Stripe\Util\RequestOptions $opts
     *
     * @return string
     */
