 ...
 */
class CalculationService extends \GiftFlow\Vendor\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<\GiftFlow\Vendor\Stripe\Tax\CalculationLineItem>
     *
     ...
     * @param null|RequestOptionsArray|\GiftFlow\Vendor\Stripe\Util\RequestOptions $opts
     *
     * @return \GiftFlow\Vendor\Stripe\Tax\Calculation
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
