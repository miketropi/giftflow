 ...
 */
class EventDestinationService extends \GiftFlow\Vendor\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\V2\Collection<\GiftFlow\Vendor\Stripe\V2\Core\EventDestination>
     *
     ...
     * @param null|RequestOptionsArray|\GiftFlow\Vendor\Stripe\Util\RequestOptions $opts
     *
     * @return \GiftFlow\Vendor\Stripe\V2\Core\EventDestination
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\GiftFlow\Vendor\Stripe\Util\RequestOptions $opts
     *
     * @return \GiftFlow\Vendor\Stripe\V2\DeletedObject
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
