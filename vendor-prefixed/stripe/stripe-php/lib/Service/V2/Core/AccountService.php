 ...
 */
class AccountService extends \GiftFlow\Vendor\Stripe\Service\AbstractService
{
    use \GiftFlow\Vendor\Stripe\Service\ServiceNavigatorTrait;
    protected static $classMap = ['persons' => \GiftFlow\Vendor\Stripe\Service\V2\Core\Accounts\PersonService::class, 'personTokens' => \GiftFlow\Vendor\Stripe\Service\V2\Core\Accounts\PersonTokenService::class];
    /**
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\V2\Collection<\GiftFlow\Vendor\Stripe\V2\Core\Account>
     *
