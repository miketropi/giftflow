 ...
 */
class MeterEventStreamService extends \GiftFlow\Vendor\Stripe\Service\AbstractService
{
    /**
     ...
     * @return void
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\TemporarySessionExpiredException
     */
