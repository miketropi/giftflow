 ...
 * @property null|(object{account?: string|\GiftFlow\Vendor\Stripe\Account, customer?: string|\GiftFlow\Vendor\Stripe\Customer, customer_account?: string, type: string}&\GiftFlow\Vendor\Stripe\StripeObject) $account_holder The account holder for whom accounts are collected in this session.
 * @property \GiftFlow\Vendor\Stripe\Collection<Account> $accounts The accounts that were collected as part of this Session.
 * @property null|string $client_secret A value that will be passed to the client to launch the authentication flow.
 * @property null|(object{account_subcategories: null|string[], countries: null|string[]}&\GiftFlow\Vendor\Stripe\StripeObject) $filters
