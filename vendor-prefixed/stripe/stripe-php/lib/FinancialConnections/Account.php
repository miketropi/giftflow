...
namespace GiftFlow\Vendor\Stripe\FinancialConnections;
 ...
 * @property null|(object{account?: string|\GiftFlow\Vendor\Stripe\Account, customer?: string|\GiftFlow\Vendor\Stripe\Customer, customer_account?: string, type: string}&\GiftFlow\Vendor\Stripe\StripeObject) $account_holder The account holder that this account belongs to.
 * @property null|((object{expected_expiry_date: null|int, identifier_type: string, status: string, supported_networks: string[]}&\GiftFlow\Vendor\Stripe\StripeObject))[] $account_numbers Details about the account numbers.
 * @property null|(object{as_of: int, cash?: (object{available: null|\GiftFlow\Vendor\Stripe\StripeObject}&\GiftFlow\Vendor\Stripe\StripeObject), credit?: (object{used: null|\GiftFlow\Vendor\Stripe\StripeObject}&\GiftFlow\Vendor\Stripe\StripeObject), current: \GiftFlow\Vendor\Stripe\StripeObject, type: string}&\GiftFlow\Vendor\Stripe\StripeObject) $balance The most recent information about the account's balance.
 * @property null|(object{last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\GiftFlow\Vendor\Stripe\StripeObject) $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|(object{last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\GiftFlow\Vendor\Stripe\StripeObject) $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 * @property null|(object{id: string, last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\GiftFlow\Vendor\Stripe\StripeObject) $transaction_refresh The state of the most recent attempt to refresh the account transactions.
 */
class Account extends \GiftFlow\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<Account> of ApiResources
     *
     ...
     * @param null|array|string $opts
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<AccountOwner> list of account owners
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
