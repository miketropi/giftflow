...
namespace GiftFlow\Vendor\Stripe\Apps;
 ...
 * @property (object{type: string, user?: string}&\GiftFlow\Vendor\Stripe\StripeObject) $scope
 */
class Secret extends \GiftFlow\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \GiftFlow\Vendor\Stripe\Collection<Secret> of ApiResources
     *
     * @throws \GiftFlow\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
