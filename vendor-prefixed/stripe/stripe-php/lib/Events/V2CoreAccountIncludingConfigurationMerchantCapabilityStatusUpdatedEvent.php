 ...
 * @property \GiftFlow\Vendor\Stripe\EventData\V2CoreAccountIncludingConfigurationMerchantCapabilityStatusUpdatedEventData $data data associated with the event
 */
class V2CoreAccountIncludingConfigurationMerchantCapabilityStatusUpdatedEvent extends \GiftFlow\Vendor\Stripe\V2\Core\Event
{
    ...
    public static function constructFrom($values, $opts = null, $apiMode = 'v2')
    {
        ...
        if (null !== $evt->data) {
            $evt->data = \GiftFlow\Vendor\Stripe\EventData\V2CoreAccountIncludingConfigurationMerchantCapabilityStatusUpdatedEventData::constructFrom($evt->data, $opts, $apiMode);
        }
