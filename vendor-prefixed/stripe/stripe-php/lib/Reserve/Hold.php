...
namespace GiftFlow\Vendor\Stripe\Reserve;
 ...
 * @property (object{release_after: null|int, scheduled_release: null|int}&\GiftFlow\Vendor\Stripe\StripeObject) $release_schedule
 * @property null|Plan|string $reserve_plan The ReservePlan which produced this ReserveHold (i.e., resplan_123)
 * @property null|string|\GiftFlow\Vendor\Stripe\Charge $source_charge The Charge which funded this ReserveHold (e.g., ch_123)
 ...
 */
class Hold extends \GiftFlow\Vendor\Stripe\ApiResource
{
